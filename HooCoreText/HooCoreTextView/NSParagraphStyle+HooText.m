...
//    CGFloat paragraphSpacing_;
//    CGFloat alignment_;
//    CGFloat firstLineHeadIndent_;
//    CGFloat headIndent_;
//    CGFloat tailIndent_;
//    CGFloat lineBreakMode_;
//    CGFloat minimumLineHeight_;
//    CGFloat maximumLineHeight_;
//    CGFloat baseWritingDirection_;
//    CGFloat lineHeightMultiple_;
//    CGFloat paragraphSpacingBefore_;
//    NSArray *tabStops_;
//    CGFloat defaultTabInterval_;
//}
@end
    ...
    if([self respondsToSelector:@selector(tabStops)]) {
        ...
        if ([self respondsToSelector:@selector(tabStops)]) {
            ...
            if (numTabs) {
                ...
                CFArrayRef tabStops = (__bridge_retained CFArrayRef)(tabs);
